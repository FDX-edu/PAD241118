...
> '**Json Parsing**'
> JSON 형식으로 전달된 데이터를 프로그램에서 사용할 수 있는 형식으로 변환하는 과정
<br/>
1 - 1) [Json 구문 분석] 작업액션을 추가합니다.<br/>
- 검색: Json<br/>
- 런타임: 기본 제공<br/>
![슬라이드8](https://github.com/user-attachments/assets/2e9355f7-d046-411b-9c54-e5b77bb42908)
...
![슬라이드9](https://github.com/user-attachments/assets/a8845c03-6b77-42b0-8512-a39db5c65c93)
