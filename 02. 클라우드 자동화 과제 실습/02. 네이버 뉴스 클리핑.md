![image](https://github.com/user-attachments/assets/e9d89859-99b4-4bcd-a087-f9da87e37d44)# 개요
...
> 위치: Group - MSFT
> 문서 라이브러리: Documents
> 파일: /General/userXX/뉴스모음.xlsx
> 테이블: NewsTable

2 - 2) 고급 매개 변수를 다음과 같이 진행합니다.
> Title: `@{items('For_each')?['title']}`
> OriginalLink: `@{item()?['originallink']}`
> Description: `@{item()?['description']}`
> PubDate: `@{body('JSON_구문_분석')?['lastBuildDate']}`

- 위의 항목을 복사하기 보단, 아래 사진의 방법처럼 변수 설정하는 것을 추천합니다.
